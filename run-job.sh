# Variabel-variabel
FILE_JAR=target/UASBigdata-1.0-SNAPSHOT.jar
HADOOP_USERNAME=hadoopuser
IP_NAMENODE=192.168.1.37
HOME_DIR=/home/hadoopuser/
NAMA_JAR_TUJUAN=UASBigdata.jar
PACKAGE_ID=org.example.App
INPUT_FOLDER_COUNTRY=/brian/Input/Country
INPUT_FOLDER_POPULATION=/brian/Input/Population
OUTPUT_FOLDER=/brian/Hasil
...
HADOOP_JAR_COMMAND="hadoop jar ${NAMA_JAR_TUJUAN} ${PACKAGE_ID} ${INPUT_FOLDER_COUNTRY} ${INPUT_FOLDER_POPULATION} ${OUTPUT_FOLDER}"
